...
use App\Http\Livewire\QuestionStoryComponent;


use App\Http\Livewire\QuizGluten;
...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::get('/dashboard/introduction', [DashboardController::class, 'introduction'])->name('introduction');

    Route::get('/quiz', [DashboardController::class, 'quiz'])->name('quizzes.index');
    //Route::get('/quiz/gluten', [DashboardController::class, 'quizgluten'])->name('quizzes.gluten');

    //Route::get('/quiz/gluten', function () {
    //    return view('quiz/gluten');
   // })->name('quizgluten');


    // Route::get('/quiz/{allergen}', [QuizController::class, 'show'])->name('quiz.show');

    // Route::get('/quiz/{allergen}', [QuizController::class, 'show'])->name('quiz.show');

    // Route::get('/quiz/{allergen}', [QuizController::class, 'show'])->name('quiz.show');

   //Route::get('/quiz/{allergen}', Quiz::class)->name('quiz');
   //Route::get('/quiz/{allergen}', Quiz::class)->name('quiz');

   //Route::get('/quiz/gluten', [QuizController::class, 'gluten'])->name('quiz.gluten');
   
    // Route::get('/quiz/{allergen}', function ($allergen) {
     //return view('quiz', ['allergen' => $allergen]);
   // })->name('quiz');


    // Route::get('/quiz/{allergen}', [QuizController::class, 'showQuiz'])->name('quiz');



    //Route::get('/quiz/gluten', )->name('quiz.gluten');

    //Route::get('/quiz/pollen', QuestionStoryComponent::class)->name('quiz.pollen');
    

    Route::get('/quiz/gluten', QuestionStoryComponent::class)->name('quiz.gluten');

    Route::get('/quiz/pollen', Quiz::class)->name('quiz.pollen');
